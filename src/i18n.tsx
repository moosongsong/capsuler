...
const UI = {
  ko: {
    ...
    login_name: '송무송 님', login_sub: 'musong@coffee.app · 카카오로 로그인됨', login_name2: '계정 관리 (준비 중)', login_sub2: '실제 앱에서는 프로필·로그아웃 메뉴가 열려요',
    stat_fav: '찜', stat_review: '후기', stat_avg: '평균 별점',
    my_reviews_h: '내가 마셨던 캡슐 후기', my_reviews_empty1: '아직 남긴 후기가 없어요', my_reviews_empty2: '캡슐 상세에서 별점과 한 줄을 남겨보세요',
    ...
    intensity_bar: '막대', intensity_num: '숫자', set_lang: '언어', set_lang_desc: '캡슐 이름·라벨 표시 언어', footer: '오늘의 한 잔 · v0.1 프로토타입',
    decaf_label: '디카페인', compat_h: '호환 머신', notes_h: '향미 노트', review_h: '내 후기', review_ph: '마셔본 느낌을 한 줄 남겨보세요',
  ...
  en: {
    ...
    login_name: 'Moosong', login_sub: 'musong@coffee.app · Signed in with Kakao', login_name2: 'Account (coming soon)', login_sub2: 'The real app opens profile & sign-out here',
    stat_fav: 'Saved', stat_review: 'Reviews', stat_avg: 'Avg. rating',
    my_reviews_h: 'Capsules I’ve reviewed', my_reviews_empty1: 'No reviews yet', my_reviews_empty2: 'Leave a rating and note on a capsule’s detail page',
    ...
    intensity_bar: 'Bars', intensity_num: 'Number', set_lang: 'Language', set_lang_desc: 'Language for capsule names & labels', footer: 'Today’s Cup · v0.1 prototype',
    decaf_label: 'Decaf', compat_h: 'Compatible machines', notes_h: 'Aroma notes', review_h: 'My review', review_ph: 'Leave a note about how it tasted',
